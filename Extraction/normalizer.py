...
def extract_page_info_from_filename(pdf_path: str) -> dict | None:
    ...
    rest = m.group(2)  # e.g. "-35" or "-37" or "-54-55-56" or ""
...
def call_openai(
    ...
    for attempt in range(MAX_RETRIES):
        #print(f"[INFO] Sending request  : please wait (30–120s for large PDFs)...")
        ...
        try:
            ...
            if attempt < MAX_RETRIES - 1:
                ...
                print(f"\n[WARN] Attempt {attempt + 1}/{MAX_RETRIES} failed: {e}")
